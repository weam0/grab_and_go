...
@section('content')
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-dark display-6">Add New Inventory Item</h1>
    </div>
    <div class="container">
        <div class="row">
                ...
                <form action="{{ route('admin.inventories.store') }}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="row">
                       ...
                       <div class="mb-4 col-md-6">
                           ...
                           <input type="number" name="price" id="price" class="form-control" step="0.01" value="{{ old('price', 0.00) }}" min="0" required>
                           @error('price')
                           <small class="text-danger">{{ $message }}</small>
                           @enderror
                       </div>
                       ...
                       <div class="mb-4 col-md-6">
                           ...
                           <input type="number" name="weight" id="weight" class="form-control" step="0.01" value="{{ old('weight') }}" min="0">
                           @error('weight')
                           <small class="text-danger">{{ $message }}</small>
                           @enderror
                       </div>
                       <div class="mb-4 col-md-6">
                           ...
                           <input type="date" name="expiryDate" id="expiryDate" class="form-control" value="{{ old('expiryDate') }}">
                           @error('expiryDate')
                           <small class="text-danger">{{ $message }}</small>
                           @enderror
                       </div>
                       <div class="mb-4 col-md-6">
                           ...
                           <input type="text" name="batchNumber" id="batchNumber" class="form-control" value="{{ old('batchNumber') }}">
                           @error('batchNumber')
                           <small class="text-danger">{{ $message }}</small>
                           @enderror
                       </div>
                       <div class="mb-4 col-md-6">
                           ...
                           <input type="date" name="lastUpdate" id="lastUpdate" class="form-control" value="{{ old('lastUpdate') }}">
                           @error('lastUpdate')
                           <small class="text-danger">{{ $message }}</small>
                           @enderror
                       </div>
                       <div class="mb-4 col-md-6">
                           ...
                           <input type="text" name="shelfLocation" id="shelfLocation" class="form-control" value="{{ old('shelfLocation') }}">
                           @error('shelfLocation')
                           <small class="text-danger">{{ $message }}</small>
                           @enderror
                       </div>
